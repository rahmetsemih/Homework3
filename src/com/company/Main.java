...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student veli = new Student(2,"Veli","Bakýrtaþ","veli@gmail.com","a street","university");
        Student mehmet = new Student(3,"Mehmet","Bakýrtaþ","mehmet@gmail.com","b street","high school");
